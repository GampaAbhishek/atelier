        ...
        <div className='flex gap-6'>
          ...
          <div className='flex-1'>
            ...
            <div className='flex gap-2'>
              ...
              <label
                htmlFor='file-input'
                className='flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-white cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center'
              >

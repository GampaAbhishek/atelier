    ...
    <div className="min-h-[90vh] bg-[#DCF1F9]">
      <div className="bg-white rounded-2xl p-7 m-3 h-full flex max-md:flex-col">
        ...
        <div className="flex flex-col w-full md:w-1/2 justify-center items-center gap-10 p-6 md:p-0">
          <div className="flex flex-col gap-6"><h1 className="text-[#1BACE1] text-4xl md:text-7xl md:text-center">
            Se connecter
          </h1>
            <form className="flex flex-col gap-6 w-full max-w-sm">
              ...
              <div className="flex flex-col gap-3 justify-end items-start">
                <button
                  className="bg-[#1BACE1] cursor-pointer text-white px-6 rounded-lg py-3 font-medium hover:bg-[#169bc8] transition w-full md:w-auto"
                  onClick={handleLogin}
                >
                  SE CONNECTER
                </button>
